...
* <pre>
* var TestRidockNpm = require('index'); // See note below*.
* var xxxSvc = new TestRidockNpm.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new TestRidockNpm.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new TestRidockNpm.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new TestRidockNpm.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
